...
# https://github.com/goplugin/plugin_latest/blob/600365a7a27508d699dbd4b994fafba7dc288659/integration-tests/client/plugin_k8s.go#L82-L83
...
for ((i = 1; i <= NODE_COUNT; i++)); do
	...
	docker run \
		...
		-e "CL_DATABASE_URL=postgresql://postgres:postgres@plugin.postgres:5432/${database_name}?sslmode=disable" \
