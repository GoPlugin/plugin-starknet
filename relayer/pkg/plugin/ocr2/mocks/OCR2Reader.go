...
import (
	...
	ocr2 "github.com/goplugin/plugin-starknet/relayer/pkg/plugin/ocr2"

	starknet "github.com/goplugin/plugin-starknet/relayer/pkg/starknet"
)
...
func (_m *OCR2Reader) BaseReader() starknet.Reader {
	...
	if len(ret) == 0 {
		panic("no return value specified for BaseReader")
	}
...
func (_m *OCR2Reader) BillingDetails(_a0 context.Context, _a1 *felt.Felt) (ocr2.BillingDetails, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for BillingDetails")
	}

	var r0 ocr2.BillingDetails
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) (ocr2.BillingDetails, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) ocr2.BillingDetails); ok {
		r0 = rf(_a0, _a1)
	} else {
...
func (_m *OCR2Reader) ConfigFromEventAt(_a0 context.Context, _a1 *felt.Felt, _a2 uint64) (ocr2.ContractConfig, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ConfigFromEventAt")
	}

	var r0 ocr2.ContractConfig
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt, uint64) (ocr2.ContractConfig, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt, uint64) ocr2.ContractConfig); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Get(0).(ocr2.ContractConfig)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *felt.Felt, uint64) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *OCR2Reader) LatestConfigDetails(_a0 context.Context, _a1 *felt.Felt) (ocr2.ContractConfigDetails, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) (ocr2.ContractConfigDetails, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) ocr2.ContractConfigDetails); ok {
		r0 = rf(_a0, _a1)
	} else {
...
func (_m *OCR2Reader) LatestRoundData(_a0 context.Context, _a1 *felt.Felt) (ocr2.RoundData, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) (ocr2.RoundData, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) ocr2.RoundData); ok {
		r0 = rf(_a0, _a1)
	} else {
...
func (_m *OCR2Reader) LatestTransmissionDetails(_a0 context.Context, _a1 *felt.Felt) (ocr2.TransmissionDetails, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for LatestTransmissionDetails")
	}

	var r0 ocr2.TransmissionDetails
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) (ocr2.TransmissionDetails, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt) ocr2.TransmissionDetails); ok {
		r0 = rf(_a0, _a1)
	} else {
...
func (_m *OCR2Reader) NewTransmissionsFromEventsAt(_a0 context.Context, _a1 *felt.Felt, _a2 uint64) ([]ocr2.NewTransmissionEvent, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for NewTransmissionsFromEventsAt")
	}

	var r0 []ocr2.NewTransmissionEvent
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt, uint64) ([]ocr2.NewTransmissionEvent, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *felt.Felt, uint64) []ocr2.NewTransmissionEvent); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
