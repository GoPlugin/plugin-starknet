...
require (
	...
	github.com/goplugin/plugin-testing-framework/lib v0.3.1 //plugin update changes
	...
	//github.com/goplugin/plugin-starknet/relayer v0.0.1-beta-test.0.20241009122052-5e3515805bca
	...
	//github.com/goplugin/pluginv3.0/integration-tests v0.0.0-20241011113521-7a311a7bf77d
	github.com/goplugin/pluginv3.0/v2 v2.4.0
	//github.com/goplugin/pluginv3.0/v2 v2.14.0-mercury-20240807.0.20241011113521-7a311a7bf77d
...
require (
	...
	//github.com/goplugin/plugin-cosmos v0.5.0 // indirect
