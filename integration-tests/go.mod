...
require (
	...
	github.com/goplugin/plugin-starknet/relayer v0.1.3 //plugin update changes
	...
	github.com/goplugin/pluginv3.0 v2.2.0 //plugin update changes
...
require (
	...
	github.com/goplugin/plugin-testing-framework/wasp v1.50.0 v0.0.1 //plugin update changes
