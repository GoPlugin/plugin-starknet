...
import (
	...
	"github.com/goplugin/plugin_latest/integration-tests/docker/test_env"
	"github.com/goplugin/plugin_latest/core/services/job"
...
func (c *Common) CreateJobsForContract(cc *PluginClient, observationSource string, juelsPerFeeCoinSource string, ocrControllerAddress string, accountAddresses []string) error {
