...
func (c *TestConfig) ReadEnvVars() {
	image := ctf_config.MustReadEnvVar_String("PLUGIN_IMAGE")
	c.PluginImage.Image = &image
	version := ctf_config.MustReadEnvVar_String("PLUGIN_VERSION")
	c.PluginImage.Version = &version
}
