...
- **Tx1** contains Plugin’s transaction to set the status of the Sequencer as being down on L2.
...
[Code](https://github.com/gopluginexternal-adapters-js/tree/develop/packages/sources/layer2-sequencer-health)
