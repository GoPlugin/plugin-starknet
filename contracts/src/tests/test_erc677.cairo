...
use plugin::libraries::token::v2::erc677::ERC677Component;
use plugin::libraries::token::v2::erc677::ERC677Component::ERC677Impl;
...
type ComponentState =
    ERC677Component::ComponentState<plugin::token::v2::link_token::LinkToken::ContractState>;
